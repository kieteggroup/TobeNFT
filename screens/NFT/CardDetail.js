...
import MainContainerNFT from './MainContainerNFT';
            ...
            <View style={styles.wrapper}>
                ...
                >
                    ...
                    <View style={styles.body}>
                        ...
                        <ButtonCustom
                            text="Buy now"
                            buttonStyle={{ width: WIDTH.width100, borderWidth: 0, marginVertical: 15 }}
                            backgroundLinearGradient={['#780D69', '#EC0174']}
                            start={{ x: 0, y: 0 }}
                            end={{ x: 1, y: 0 }}
                            buttonStyleText={{ fontFamily: FONT.bold, fontWeight: 700 }}
                        />
